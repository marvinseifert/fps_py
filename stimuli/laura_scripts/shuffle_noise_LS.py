...
def shuffle_pattern(pattern, checker_size, shuffle_size_px):
    ...
    shifts = np.arange(0, checker_size, checker_size // shuffle_size_px)  # Get the possible shifts
...
def generate_and_store_3d_array(
    ...
    for _ in range(frames):
        ...
        shuffled_pattern = shuffle_pattern(pattern, checkerboard_size, shuffle_size_px=12) # hardcoded **
